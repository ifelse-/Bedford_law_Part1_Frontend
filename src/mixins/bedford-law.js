export default {
    methods: {
        ...
        */
        ...
        const firstDigits = data.map(function (item)
        {
            return item.toString()[0];
        });
    
        const firstDigitFrequencies = this.getDigitsFrequencies(firstDigits);
        ...
        //console.log('From mixins bedfords results', results)
        return results;
          },
         getDigitsFrequencies(firstDigits)
          {
